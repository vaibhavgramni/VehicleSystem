...
function vehiclenoonblur()
{
    ...
    {
        lvehicleno.innerHTML="Valid Data";
        lvehicleno.style.visibility="visible";
        lvehicleno.style.color="green";
        count+=1;
    }
    else 
    {
        lvehicleno.innerHTML="Invalid Data";
        lvehicleno.style.visibility="visible";
        lvehicleno.style.color="red";
    }
}
