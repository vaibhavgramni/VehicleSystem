...
<i class="fa fa-envelope"></i> CONTACT</a>-->
                ...
                <div class="registration"><br>
                    ...
                    <form  align="left" action="UpdateformServlet" onsubmit="return Validate()" method="Post">
                    ...
                    <input type="text" name="vehicleno" id="vehicleno" placeholder="<%=vehicleno %>" disabled> 
