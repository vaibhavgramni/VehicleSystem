...
<head>
  ...
  <title>Vehicle Register</title>
        ...
        <link rel='stylesheet' type="text/css" href="VehicleInfo.css">
...
<i class="fa fa-envelope"></i> CONTACT</a>-->
	...
	<br />
                <div class="registration"><br>
                    ...
                    <form  align="left" action="Vehicleinfo" onsubmit="return Validate()" method="Post">
                    <br><h1 align="center">New Vehicle Registration<br></h1><br>
                    
                    <span class="number">1</span> Vehicle Number
                    <input type="text" name="vehicleno" id="vehicleno" placeholder="Enter Vehicle Number" onblur="vehiclenoonblur()" required> 
                    ...
                    <select name="branch" id="userb" placeholder="Enter Branch" onchange="userbranch()" required>
                        <option value=""></option>
