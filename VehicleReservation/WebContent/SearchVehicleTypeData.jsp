...
<title>Vehicle Type Search Details</title>
</head>
<body>
...
%><br>
	...
	<br>	
		...
		<table align="center" cellpadding="5" cellspacing="5" border="1">
			...
			<tr>
				...
				try {
		               ...
		               pstmt=con.prepareStatement("select * from vehicleinfo1 where vehicletype='"+vehicletype+"'");
		...
		<br>
		<p style = "color:white"><center><h1>Fig: Search on the basis of date</h1></center></p>
</body>
</html>
