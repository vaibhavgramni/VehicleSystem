...
<body>
                ...
                <div class="registration">
                    ...
                    <form align="center" action="UpdateformServlet2" onsubmit="return Validate()" method="Post">   
                    VehicleNo<input type="text" name="vehicleno" id="vehicleno" placeholder="Enter Vehicle No " onblur="vehiclenoonblur()" required> 
                    <br>
                    <br>
